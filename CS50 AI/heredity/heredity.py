...
def joint_probability(people, one_gene, two_genes, have_trait):
    ...
    for person in people:
        ...
        trait_prob = PROBS['trait'][gene][person_trait]
...
def normalize(probabilities):
    ...
    for person in probabilities:
        #the trait values first
        true_val = probabilities[person]['trait'][True]
        false_val = probabilities[person]['trait'][False]

        if (true_val and false_val) != 0:
            ratio_trait = (1 / (true_val + false_val)  )

            probabilities[person]['trait'][True] *= ratio_trait
            probabilities[person]['trait'][False] *= ratio_trait
        ...
        ratio_gene =  ( 1 / ( two_val + one_val + zero_val)  )
        probabilities[person]['gene'][2] *= ratio_gene
        probabilities[person]['gene'][1] *= ratio_gene
        probabilities[person]['gene'][0] *= ratio_gene
